...
public class Information extends Messages{
    ...
    public String toString(){
        ...
        data.put(Constants.INFO_LOBBY, lobbyName);
        data.put(Constants.INFO_P1, player1);
        data.put(Constants.INFO_P2, player2);
        data.put(Constants.INFO_ADR, address);
    ...
    public void strToInfo(String info){
        ...
        lobbyName = data.get(Constants.INFO_LOBBY);
        player1 = data.get(Constants.INFO_P1);
        player2 = data.get(Constants.INFO_P2);
        address = data.get(Constants.INFO_ADR);
    }
