...
public class CreateLobbyScreen extends AbstractScreen {
    ...
    private void updateSliderValues(){
        ...
        String update = Messages.getDataStr(Constants.INFO_LOBBY,
                                            Constants.WINNING_POINTS,
                                            (int)winningPoints.getValue() + "",
                                            Constants.SELECTED_BALL,
    ...
    private void startGame(){
        ...
        String message = Messages.getDataStr(Constants.CMD.START_GAME);
